    ...
    <div className="min-h-screen text-white font-sans" style={{ background: '#0a0908' }}>
      ...
      >
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <span className="font-heading text-base tracking-tight">Prompt Skill Manager</span>
      ...
      <footer className="border-t border-[rgba(255,255,255,0.06)] py-8">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <span className="font-heading text-base text-white">Prompt Skill Manager</span>
